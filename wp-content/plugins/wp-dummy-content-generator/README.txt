...
- Dummy Users of all the available  user roles.
...
The dummy data is created by the plugin. You can use the plugin to produce dummy data and delete it whenever you want on both the development and production/live websites because the plugin has the ability to delete all the generated data with a single click.
